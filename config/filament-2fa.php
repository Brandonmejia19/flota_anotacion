...
return [
    ...
    */
    ...
    'force' => true, // Si es true, obliga a todos los usuarios a activar 2FA
    'notification' => true, // Envía una notificación después de activar 2FA
    'recovery' => true, // Habilita códigos de recuperación
    'enabled_features' => [
        /*
        |--------------------------------------------------------------------------
        | Register
